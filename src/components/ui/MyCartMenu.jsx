      ...
      <Offcanvas.Body className="px-0 pb-0">
        <div className="d-flex flex-column justify-content-between h-100">
                ...
                cartItems?.map((item) => (
                  <div className="cart-items mb-3" key={item?.product.id}>
                    ...
                    <div className="product-details w-100 ms-3">
                      <p className="item-name text-black fw-500 mb-0 me-2 me-md-0">
                        {item?.product?.name}
                      </p>
                    ...
                    <div className="product-quantity text-end">
                      <div
                        className="quantity-manage gap-1 mb-lg-2 mb-1"
                      ...
                      >
                        ...
                        <button className="quantity-count d-inline-block border-0 bg-white text-orange fw-600">
                          {item?.item_quantity}
                        </button>
                        <button
                ...
                <>
                  <div className="text-center py-4">
                    <img
                      src={emptyCart}
                      alt="empty-cart"
                      className="img-fluid mx-auto empty-cart-image"
                    />
                    ...
                    <Link
                      className="button-primary fs-6 d-inline-block fw-normal"
                      to="/products"
                    >
                      Browse Products
                    </Link>
          ...
          {cartItems?.length > 0 && (
            <>
              <div
                className="total-amount-wrapper py-3 px-md-4 px-3"
              ...
              >
                ...
                <Link
                  to="/checkout"
                  onClick={onCloseCart}
                  className="button-primary w-100 d-block text-center"
                >
                  Checkout
                </Link>
              </div>
