...
const AddCoupon = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            free_quantity_unit: Yup.string().required("Free quantity unit is required"),
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.buy_quantity && Boolean(formik.errors.buy_quantity)}
                                            helperText={formik.touched.buy_quantity && formik.errors.buy_quantity}
                                        />
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.buy_quantity_unit && Boolean(formik.errors.buy_quantity_unit)}
                                            helperText={formik.touched.buy_quantity_unit && formik.errors.buy_quantity_unit}
                                        />
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.free_quantity && Boolean(formik.errors.free_quantity)}
                                            helperText={formik.touched.free_quantity && formik.errors.free_quantity}
                                        />
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.free_quantity_unit && Boolean(formik.errors.free_quantity_unit)}
                                            helperText={formik.touched.free_quantity_unit && formik.errors.free_quantity_unit}
                                        />
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.buy_product && Boolean(formik.errors.buy_product)}
                                            helperText={formik.touched.buy_product && formik.errors.buy_product}
                                        />
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <TextField
                                            ...
                                            onChange={formik.handleChange}
                                            onBlur={formik.handleBlur}
                                            error={formik.touched.free_product && Boolean(formik.errors.free_product)}
                                            helperText={formik.touched.free_product && formik.errors.free_product}
                                        />
                                    </div>
                                    <div className="col-md-12 mb-4 text-end">
                                        <button type="submit" className="lt-yellow-button me-3">Save</button>
