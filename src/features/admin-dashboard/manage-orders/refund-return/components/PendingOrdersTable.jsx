  ...
  return (
    <div className="datatable">
      <DataTable value={orders} paginator rows={10}>
        ...
        <Column field="payment type" header="AMOUNT"></Column>
        <Column header="PAYMENT MODE" body={paymentStatusTemplate}></Column>
        <Column field="date" header="ORDER DATE"></Column>
        <Column field="date" header="REQUESTED"></Column>
        <Column field="date" header="ATTACHMENT"></Column>
