...
import {
  getOrderAdminApi,
  downloadInvoiceApi,trackOrderApi
...
const AdminOrderDetail = () => {
 ...
 const getTrackOrder = async () => {
    try {
      ...
      setSteps(response?.data?.tracking_status);
  ...
  //   { status: "accepted", is_active: false, date: "", time: "" },
  //   { status: "dispatched", is_active: false, date: "", time: "" },
  //   { status: "out_for_delivery", is_active: false, date: "", time: "" },
  //   { status: "delivered", is_active: false, date: "", time: "" },
  //   { status: "cancelled", is_active: false, date: "", time: "" },
  // ];
  // const stepsline = steps?.filter((items) => items.name !== "confirmed");
  // const currentStepIndex = stepsline.findIndex(
  //   (step) => step.name === currentStatus
  // );
  const filteredSteps = steps.filter((step) => {
    if (step.status === "confirmed") return false; // Remove "confirmed"
    if (step.status === "cancelled") return step.is_active; // Show "cancelled" only if active
    return true; // Keep all other steps
  });
  
  const currentStepIndex = filteredSteps.findIndex((step) => step.is_active);
  ...
  const orderTemplate = (rowData) => {
    return (
      <div>
        <img
          src={rowData?.product?.images[0]?.image}
          alt="img"
          width={60}
          height={60}
        />
  ...
  return (
    <>
                ...
                <div className="w-100">
                  ...
                  >
                    ...
                    <Column
                      filed="Quanity"
                      header="QUANTITY"
                      body={(rowData) => rowData?.item_quantity}
                    ></Column>
                    <Column
                      filed="Amount"
                      header="AMOUNT"
                    ...
                    <ul>
                      ...
                      <li className="border-top py-3 text-end">
                        ...
                        <span
                          ...
                          style={{ width: "5rem" }}
                        >
                          Rs. {~~orderData?.delivery_charges}
                        </span>
                      </li>
                      {orderData?.coupon_discount > 0 && (
                        <li className="border-top py-3 text-end text-success">
                          <span
                            className="d-inline-block text-start "
                            style={{ width: "15rem" }}
                          >
                          ...
                          <span
                            ...
                            style={{ width: "5rem" }}
                          >
                            Rs. {~~orderData?.coupon_discount}
                          </span>
                        </li>
                      )}
                      {orderData?.apply_amrit_coins && (
                        <li className="border-top py-3 text-end text-success">
                          <span
                            className="d-inline-block text-start"
                            style={{ width: "15rem" }}
                          ...
                          <span
                            ...
                            style={{ width: "5rem" }}
                          >
                            Rs. {~~orderData?.amrit_coins_rs_off}
                          </span>
                        </li>
                      )}
                      <li className="border-top py-3 text-end">
                ...
                <div className="d-flex align-items-center gap-3 mb-4">
                  ...
                  <div>
                    {orderData?.status === "confirmed" ? (
                      <>
                        <button
                          className="btn light-default-button py-1"
                          style={{ backgroundColor: "#E8C51E", color: "white" }}
                        >
                          Pending
                        </button>
                      </>
                      ...
                      <button
                        className="btn light-default-button py-1"
                        style={{ backgroundColor: "#4BAE4F", color: "white" }}
                      >
                        Accepted
                      </button>
                      ...
                      <button
                        className="btn light-default-button py-1"
                        style={{ backgroundColor: "#d59615", color: "white" }}
                      >
                        Dispatched
                      </button>
                    ) : null}
                  ...
                  <div>
                    ...
                    >
                      {filteredSteps.map((step, index) => (
                        <div
                          className={`d-flex gap-3 stepper-wrapper-order ${
              ...
              <div className="card-body p-4">
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      <p className="mb-0">
                        {orderData?.delivering_to?.ads_name}
                      </p>
                      <small
                        className="fw-400"
                ...
                <div className="mb-4">
                  <p className="fw-500 text-mid-grey mb-0 pb-2 fb-fs-14">
                    Email
                  </p>
                  <p className="fw-400" style={{ color: "#584EE0" }}>
                    {orderData?.delivering_to?.ads_email ||
                      orderData?.delivering_to?.user_detail?.email ||
                      "N/A"}
                  </p>
                </div>
                <Divider />
                <div className="mt-4">
                  ...
                  <div>
                    <div className="d-flex align-items-start gap-5 pb-2">
                      ...
                      <p className="mb-0">
                        {orderData?.payment_details?.payment_mode}
                      </p>
                    </div>
                    <div className="d-flex align-items-start gap-4">
                      <p className="fw-500 mb-0">Status</p> <span> :</span>
                      <p className="mb-0 ps-3">
                        {orderData?.payment_details?.status}
                      </p>
                      {/* <button
                      style={{
                        color: "#584EE0",
            ...
            <div className="card p-2 mt-4">
              <div className="card-body p-4">
                ...
                <div className="d-flex gap-4 mt-5">
                  <p className="fw-500" style={{ width: "30%" }}>
                    Length{" "}
                  </p>{" "}
                  <span>:</span>
                  ...
                  <div className="card-body p-4">
                    ...
                    {orderData?.status === "confirmed" && (
                      <div className="mt-2 d-flex gap-4 align-items-center">
                        ...
                        <button
                          className="button-yellow d-flex gap-2 px-3 fb-fs-16"
                          onClick={() =>
                            showAcceptModal(
                              true,
                              orderData?.id,
                      ...
                      <div className="w-50">
                        ...
                        <div className="mt-4">
                          <div className="d-flex align-items-start">
                            <p className="fw-500 mb-0" style={{ width: "20%" }}>
                              Name{" "}
                            </p>{" "}
                            <span> :</span>
                            <p className="mb-0 ps-4" style={{ width: "80%" }}>
                              {orderData?.delivering_to?.ads_name || ""}
                            </p>
                          </div>
                          <div className="d-flex align-items-start pt-2">
                            ...
                            <p className="mb-0 ps-4" style={{ width: "80%" }}>
                              {" "}
                              {`${
                                orderData?.delivering_to?.house_flat_block_no ||
                                ""
                              } ${
                                orderData?.delivering_to?.road_area_colony || ""
                              } ${orderData?.delivering_to?.state || ""} ${
                                orderData?.delivering_to?.pincode || ""
                              }`}
                            </p>
                          </div>
                          <div className="d-flex align-items-start pt-2">
      ...
      />
      <AcceptDispatchOrderModal
        visible={dispatchVisible}
        getOrderList={getOrderList}
        setVisible={() => setDispatchVisible(false)}
        orderStatus={orderDispatch}
      />
    </>
  );
};
