...
const UserProfile = () => {
  return (
    <div className="web-wrapper-main">
      ...
      <div className="container fb-container ps-5  pe-5 w-75 mb-5 pb-5">
                ...
                <div className="container">
                  <div className="row border-bottom px-3 py-3">
                    <div className="col-md-3">
                      <p>
                        {" "}
                        Order ID: <span className="fw-600"> #123456789</span>
                      </p>
                    </div>
                    <div className="col-md-3">
                      <p>
                    ...
                    <div className="col-md-3">
                      <p>
                        {" "}
                        Total Amount: <span className="fw-600"> ₹ 130 </span>
                      </p>
                    </div>
          ...
          <TabPanel header="Address Book" leftIcon="pi pi-map-marker me-2">
            <div className="address-section">
              <div className="d-flex justify-content-between">
                <p className="fb-fs-26 fw-bold text-dark-grey my-4">Saved Address</p>
                  ...
                  <div className="row">
                    <div className="col-md-9">
                      <div className="order-date d-flex">
                        ...
                        />
                        <div className="ms-3">
                          <p className="fw-600 fb-fs-18 mt-1">
                            Piyush Kanwal | 7464810000
                          </p>
