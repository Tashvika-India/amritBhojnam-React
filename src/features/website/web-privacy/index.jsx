        ...
        <div className="container fb-container">
          <div className="fb-pt-5">
            ...
            <div className="py-5 mt-5">
              ...
              <p>
                ...
                purchase from amritbhojanam.com (the "Site") or otherwise
                communicate with us regarding the Site (collectively, the
                "Services"). For purposes of this Privacy Policy, "you" and
                "your" means you as the user of the Services, whether you are a
          ...
          <div className="section-1 mb-5">
            ...
            <p className="fb-fs-12">
              ...
              <span className="fw-600">Cookies</span>"). Usage Data may include
          ...
          <div className="section-1 mb-5">
            ...
            <ul>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Providing Products and Services.</span>
              ...
              <li style={{ listStyleType: "disc" }}>
                ...
                may use your personal information for marketing and promotional
              ...
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Security and Fraud Prevention. </span>
          ...
          <div className="section-1 mb-5">
            ...
            <p className="fb-fs-12">
              ...
              in transit. We recommend that you do not use insecure channels to
          ...
          <div className="section-1 mb-5">
            ...
            <ul>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Right to Access / Know: </span> You may
                have a right to request access to personal information that we
                hold about you, including details relating to the ways in which
                we use and share your information.
              </li>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Right to Delete:</span> You may have a
                right to request that we delete personal information we maintain
                about you.
              </li>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Right to Correct:</span> You may have a
              ...
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Restriction of Processing: </span> You
                may have the right to ask us to stop or restrict our processing
                of personal information.
              </li>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Withdrawal of Consent:</span> Where we
                rely on consent to process your personal information, you may
                have the right to withdraw this consent.
              </li>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">Appeal:</span> You may have a right to
                appeal our decision if we decline to process your request. You
                can do so by replying directly to our denial.
              </li>
              <li style={{ listStyleType: "disc" }}>
                <span className="fw-600">
