          ...
          <div className="container fb-container">
            <div className=" ">
              ...
              <div className="py-lg-5 py-3 mt-lg-5 mt-0">
                ...
                <p>
                  ...
                  personal information when you visit, use our services, or make
                  a purchase from amritbhojanam.com (the "Site") or otherwise
                  ...
                  a customer, website visitor, or another individual whose
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <p className="fb-fs-12">
                ...
                that we collect and use varies depending on how you interact
                with us.
              </p>
              <p>
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <ul>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Contact details</span> including your
                  name, address, phone number, and email.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600"> Order information</span> including
                  your name, billing address, shipping address, payment
                  confirmation, email address, and phone number.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Account information</span> including
                  your username, password, security questions and other
                  information used for account security purposes.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600"> Customer support information</span>{" "}
                  including the information you choose to include in
                  communications with us, for example, when sending a message
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <p className="fb-fs-12">
                ...
                <span className="fw-600">Usage Data</span>"). To do this, we may
                use cookies, pixels and similar technologies ("
                <span className="fw-600">Cookies</span>"). Usage Data may
                include information about how you access and use our Site and
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <ul>
                <li style={{ listStyleType: "disc" }}>
                  ...
                  to process your payments, fulfill your orders, to send
                ...
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Marketing and Advertising. </span> We
                  may use your personal information for marketing and
                  promotional purposes, such as to send marketing, advertising
                  and promotional communications by email, text message or
                  postal mail, and to show you advertisements for products or
                  services. This may include using your personal information to
                  better tailor the Services and advertising on our Site and
                  other websites.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <p className="fb-fs-12">
                ...
                https://www.shopify.com/legal/cookies. We use Cookies to power
                and improve our Site and our Services (including to remember
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <p>
                ...
                out above in "How we Collect and Use your Personal Information"
                and "How we Disclose Personal Information":
              </p>

              <h6 className="fw-600">Category</h6>
              <ul>
                <li style={{ listStyleType: "disc" }}>
              ...
              <h6 className="fw-600 mt-2">Categories of Recipients</h6>
              <ul>
                <li style={{ listStyleType: "disc" }}>
                ...
                <li style={{ listStyleType: "disc" }}>Affiliates</li>
              </ul>
              <p>
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <p className="fb-fs-12">
                ...
                in transit. We recommend that you do not use insecure channels
            ...
            <div className="section-1 mb-lg-5 mb-4">
              ...
              <ul>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Right to Access / Know: </span> You
                  may have a right to request access to personal information
                  that we hold about you, including details relating to the ways
                  in which we use and share your information.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Right to Delete:</span> You may have
                  a right to request that we delete personal information we
                  maintain about you.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Right to Correct:</span> You may have
                  a right to request that we correct inaccurate personal
                  information we maintain about you.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600"> Right of Portability:</span> You may
                  have a right to receive a copy of the personal information we
                  hold about you and to request that we transfer it to a third
                  party, in certain circumstances and with certain exceptions.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Restriction of Processing: </span>{" "}
                  You may have the right to ask us to stop or restrict our
                  processing of personal information.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Withdrawal of Consent:</span> Where
                  we rely on consent to process your personal information, you
                  may have the right to withdraw this consent.
                </li>
                <li style={{ listStyleType: "disc" }}>
                  <span className="fw-600">Appeal:</span> You may have a right
                  to appeal our decision if we decline to process your request.
            ...
            <div className="section-1 mb-lg-5 mb-4 pb-5">
              ...
              <p className="fb-fs-12">
                ...
                info@amritbhojanam.com or contact us at Dwarka Sector-3 Dwarka,
                Near Highland Hospital, Delhi, DL, 110078, IN.
              </p>
            </div>
          </div>
        </section>
