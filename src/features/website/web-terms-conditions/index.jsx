          ...
          <div className=" ">
            ...
            <div className="section-5 mb-5">
              ...
              <p className="fb-fs-12">
                ...
                to our Refund Policy: [LINK TO REFUND POLICY]
              </p>
              <p>
            ...
            <div className="section-6 mb-5">
              ...
              <p>
                For more details, please review our Refund Policy: [LINK TO
                REFUND POLICY]
              </p>
            </div>
            ...
            <div className="section-7 mb-5">
              ...
              <p>
                ...
                or relating to your use of optional third-party tools. Any use
                by you of the optional tools offered through the site is
            ...
            <div className="section-10 mb-5">
              ...
              <p className="fb-fs-12">
                ...
                governed by our Privacy Policy, which can be viewed here: [LINK
                TO PRIVACY POLICY]
              </p>
            </div>
            ...
            <div className="section-13 mb-5">
              ...
              <p>
                In no case shall My Store, our directors, officers, employees,
            ...
            <div className="section-14 mb-5">
              ...
              <p className="fb-fs-12">
                You agree to indemnify, defend and hold harmless My Store and
            ...
            <div className="section-20 mb-5 pb-5">
              ...
              <p className="fb-fs-12">
              Questions about the Terms of Service should be sent to us at amrit.bhojnam@outlook.com.
              </p>
              <p>
