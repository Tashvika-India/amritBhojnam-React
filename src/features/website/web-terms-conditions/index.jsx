  ...
  return (
    ...
    <div className="container fb-container">
      <div className="fb-pt-5">
        <h1 className="fb-fs-40">Terms of Service</h1>
        <div className="fb-fs-16-big">
          <h2 className="fb-fs-30">Overview</h2>
          <p>
            This website is operated by My Store. Throughout the site, the terms
            “we”, “us” and “our” refer to My Store. My Store offers this
          ...
          <p>
            ...
            terms, conditions, and policies referenced herein and/or available
        ...
        <div className="fb-fs-16-big">
          <h2 className="fb-fs-30">Section 1 - Online Store Terms</h2>
          <p>
        ...
        <div className="fb-fs-16-big">
          <h2 className="fb-fs-30">Section 2 - General Conditions</h2>
          <p>
        ...
        <div className="fb-fs-16-big">
          <h2 className="fb-fs-30">Section 3 - Accuracy, Completeness, and Timeliness of Information</h2>
          <p>
