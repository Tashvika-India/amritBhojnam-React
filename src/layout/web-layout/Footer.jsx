            ...
            <div className="col-lg-5 col-md-12 mb-4">
              <div className="footer-detail">
                ...
                <p className="my-4 text-balance fb-fs-14  pe-5">
                  At Amrit Bhojanam, we bring the incredible health benefits of
                  millet to your table. We promote a healthier lifestyle with
                  our range of nutritious, millet-based products. Rediscover
                  millet, packed with essential nutrients and eco-friendly
                  benefits, and see how it transforms your diet and well-being.
                  Let's make millet a staple in every home!
                </p>
